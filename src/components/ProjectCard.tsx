  ...
  return (
    <div className="project-card">
      ...
      <div className="project-links">
        ...
        {!project.links.visit && !project.links.live && (
          <span className="project-status-tag" style={{ fontSize: "0.775rem", alignSelf: "center", color: "var(--text-muted)", fontFamily: "var(--font-mono)", userSelect: "none" }}>
            • shipping soon
          </span>
        )}
        {project.links.visit && (
